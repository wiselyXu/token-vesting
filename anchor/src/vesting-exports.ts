...
import VestingIDL from './features/idl/vesting.json'
import type { Vesting } from './features/vesting';
...
export function getVestingProgramId(cluster: Cluster) {
  switch (cluster) {
    ...
    case 'testnet':
      ...
      return new PublicKey('82sWJX6V6Houh8iZa6xNb7dvAbuhgfW7RuUFgavuFbCe');
    case 'mainnet-beta':
    default:
